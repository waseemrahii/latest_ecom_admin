...
const SendNotification = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#F9F9FB]  md:p-5 md:mt-8  overflow-hidden">
        ...
        <div className=" w-full bg-white grid grid-cols-1 md:grid-cols-2 rounded-lg mt-3 px-5 py-8 gap-3">
          <div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="ms-4 flex flex-col ">
              ...
              <div>
                <input
                  type="file"
                  id="image-upload"
                  className="px-2 py-2 w-full border outline-none rounded-md border-blue-300   "
            ...
            <div className="flex justify-end items-end gap-3 ">
              ...
              <button
                type="submit"
                className="rounded-md px-2 text-nowrap  bg-primary text-white py-2 border border-primary hover:bg-primary-dark"
                style={{ color: "white" }}
              >
                Send Notification
              </button>
