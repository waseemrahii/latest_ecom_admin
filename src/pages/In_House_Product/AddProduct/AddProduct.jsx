...
// } from "../../../components/redux/categorybrandSlice";
// import { createProduct } from "../../../components/redux/product/productSlice";
// import ProductImageUpload from "./AddProductForm/ProductImageUpload"; // Assuming this is where your updated component is imported
...
//   //         setThumbnail(reader.result); // Set base64 for thumbnail
//   //       } else {
//   //         setImages((prevImages) => [...prevImages, reader.result]); // Set base64 for additional images
//   //       }
//   //     };
//   //   }
//   // };
...
//       reader.onloadend = () => {
//         if (isThumbnail) {
//           setThumbnail(reader.result); // Set base64 thumbnail
//         } else {
//           setImages((prevImages) => [...prevImages, reader.result]); // Append base64 additional image
//         }
//       };
//       reader.readAsDataURL(file);
//     }
...
//     // Append images and other necessary data
//     if (thumbnail) {
//       productFormData.append("thumbnail", thumbnail); // Append base64 thumbnail
//     }
//     images.forEach((image) => {
//       productFormData.append("images", image); // Append base64 additional images
//     });
...
//       productFormData.append("attributes", attr._id);
//     });
