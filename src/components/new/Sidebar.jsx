...
import { FaAngleDown, FaAngleUp, FaKey, FaSearch } from "react-icons/fa";
...
const Sidebar = ({ setComponent }) => {
  ...
  return (
    ...
    <aside className="bg-primary pb-5  text-white top-16 bottom-0  flex flex-col fixed left-0  max-h-screen overflow-y-auto">
      ...
      <div className="px-3">
        ...
        <Link
          to="/dashboard"
          className=" w-full flex align-items-center text-left p-2 rounded hover:bg-[#52c970]  hover:text-white text-blue-700"
          style={{ color: "white" }}
        >
